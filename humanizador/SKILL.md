...
description: >-
  ...
  emoji, jargão vazio, "não apenas X, mas também Y") e pedir para "arrumar",
  "editar" ou "melhorar". Use this even without the word "humanizar".
---
...
Leia o texto procurando os padrões que denunciam IA. Os principais são listados
abaixo; o catálogo completo, com exemplos de antes/depois, está em
...
4. **Varie o ritmo** — misture frases curtas e longas. Uma frase curta depois de
   uma longa cria respiração. Texto humano não é métrico.
5. **Prefira prosa a lista** — se a informação flui como parágrafo, deixe
...
curta **"O que mudei"** com 3-5 pontos objetivos (ex.: "cortei 4 ênfases
vazias", "desfiz duas construções 'não apenas... mas também'", "transformei a
lista de 6 itens em um parágrafo").

## Exemplo

**Input:**
> É importante ressaltar que a inteligência artificial não é apenas uma
> ferramenta revolucionária, mas também um divisor de águas que está
> transformando radicalmente a forma como navegamos pelo cenário corporativo
> atual, desbloqueando um potencial sem precedentes. 🚀
